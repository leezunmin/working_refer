...
class CommunityNavigator extends StatefulWidget {
  ...
  // CommunityNavigator(this.naviKey, {this.wantKeepAlive = true});
  // CommunityNavigator(this.naviKey, {this.wantKeepAlive = false});
...
// class _CommunityNavigatorState extends State<CommunityNavigator> with AutomaticKeepAliveClientMixin {
